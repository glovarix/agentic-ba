...
The module registry is an artefact generated by `/generate-modules`. It lives at `artefacts/other/modules.md` and uses `templates/other/GM.md` as its template.
