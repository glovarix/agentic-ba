...
Three power tools together document the AI feature set at a level of detail beyond a single Product Documentation (PD) artefact — see Rule 0 and Rule 18. Their output is a category of product documentation, so it is nested under `artefacts/product-docs/ai-feature-review/`:
...
Three power tools together give a full picture of the AI feature set (see Rule 0):
